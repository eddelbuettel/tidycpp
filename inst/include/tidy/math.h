// With thanks to Rcpp and its file inst/include/Rcpp/Rmath.h (which, in case
// anybody cares to check git log or svn logs, was only written by Dirk)
...
// keep the same header guard for easier coexistence
#ifndef Rcpp_Rmath_h
#define Rcpp_Rmath_h
